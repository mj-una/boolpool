...
public class boolpool_v0_3_2 extends PApplet {
...
final float RC5 =  2.236f; // raiz de 5

// diametros
final float tamCiFo = med / RC5 * 1.2f; // --> width / RC5 * 1.2
...
final float roce = 3.8f; // --> porcentaje de velocidad que se resta cada frame
//                             [entre 3.0% y 5.0%]
...
public void draw() {
  ...
  if (pantalla == 0) { // ----------------------------------- [0]
    ...
    if (tiroPost) { // --> mouseReleased();
      ...
      v0_x *= (100 - roce) / 100.0f;
      v0_y *= (100 - roce) / 100.0f;
      v1_x *= (100 - roce) / 100.0f;
      v1_y *= (100 - roce) / 100.0f;
 ...
 /*     // solucion error de sobreposicionamieto
      ...
      if (abs(v0_x) <= 0.08f) v0_x = 0;
      if (abs(v0_y) <= 0.08f) v0_y = 0;
      if (abs(v1_x) <= 0.08f) v1_x = 0;
      if (abs(v1_y) <= 0.08f) v1_y = 0;
    ...
    // manzanas
    noStroke();
    if (turno) fill(valor0, 255 - valorT + valorT*(sin(frameCount /25.0f) + 1) /2);
    else fill(valor1, 255 - valorT + valorT*(sin(frameCount / 25.0f) + 1) /2);
    ...
    strokeWeight(width / 100);
    if (turno) {
      fill(valor0, 255 - valorT + valorT * (-sin(frameCount / 25.0f) + 1) / 2);
      noStroke();
    ...
    if (!turno) {
      fill(valor1, 255 - valorT + valorT * (-sin(frameCount / 25.0f) + 1) / 2);
      noStroke();
    ...
    stroke(valor0);
    fill(valor0);
    circle(width / 2.575f, width / 4.444f, width * 13 / 60);
    circle(width / 2.575f, width / 2.105f, width * 13 / 60); 
    circle(width / 1.579f, width / 4.444f, width * 13 / 60);
    circle(width / 1.579f, width / 2.105f, width * 13 / 60); 
    
    textFont(arialBold_d12);
    textSize(width * 9 / 30);
    textAlign(LEFT);
    text("B", width * 4 / 60, height * 20 / 60);
    text("P", width * 4.5f / 60, height * 35 / 60);
    textAlign(RIGHT);
    text("L", width * 56 / 60, height * 20 / 60);
    text("L", width * 56 / 60, height * 35 / 60);
    
    // circulos moviles
    fill(valor1, valorT + valorT * (-sin(frameCount / 25.0f) + 1) / 2);
    noStroke();
    ...
    circle(width / 2.575f + tx, width / 4.444f + ty, width * 8.5f / 60);
    circle(width / 2.575f + tx, width / 2.105f + ty, width * 8.5f / 60); 
    circle(width / 1.579f + tx, width / 4.444f + ty, width * 8.5f / 60);
    circle(width / 1.579f + tx, width / 2.105f + ty, width * 8.5f / 60); 
    ...
    else fill(valor0, valorT - valorT * (sin(frameCount / 25.0f) + 1) / 2);
    ...
    textFont(arial_d15);
    textSize(width / 24);
    text("Bool Pool v0.3.2 (26-5-23)", width / 2, height * 7.75f / 12);
    text("por Martin Julio", width / 2, height * 8.45f / 12);
    pop();
  }
    ...
    textFont(arial_d15);
    fill(valor0);
    textSize(width / 13.0f);
    text("Hay dos formas de ganar", width / 2, height * 2 / 12);
    textSize(width / 16);
    text("Capturar 4 manzanas en total,", width / 2, height * 2.9f / 12);
    textSize(width / 16.6f);
    text("o capturar las 2 manzanas de", width / 2, height * 3.8f / 12);
    text("la pantalla en un mismo tiro.", width / 2, height * 4.65f / 12);
    textSize(width / 14.8f);
    text("Pero ¡ cuidado ! No regales", width / 2, height * 5.7f / 12);
    textSize(width / 16.9f);
    text("oportunidades a tu oponente!!!", width / 2, height * 6.5f / 12);
    fill(valor0, valorT);
    textFont(arial_d15);
    textSize(width / 24);
    text("Solo son válidas las manzanas capturadas", width/2, height * 7.75f/12);
    text("durante el propio turno", width / 2, height * 8.45f / 12);
    ...
    fill(valor0);
    textFont(arialBold_d12);
    text("~ ok ~", width / 2, height * 33.2f / 40);
  }
  ...
  noStroke();
  circle(mouseX * 1.0f, mouseY * 1.0f, tiroPre ? tamCurs * RC5 / 2 : tamCurs);
  pop();
}
...
public void keyPressed() { // accesos por teclado
...
//                           o o   o o
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "boolpool_v0_3_2" };
    if (passedArgs != null) {
